...
import me.liuqingwen.android.projectbasicmvp.ui.ID_ITEM_IMAGE_VIEW
import me.liuqingwen.android.projectbasicmvp.ui.MovieListItemUI
        ...
        RecyclerView.Adapter<MovieListHolder>(), ListPreloader.PreloadModelProvider<Movie>
{
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = MovieListHolder(
            parent.context, MovieListItemUI(this.listColumnCount).createView(
